                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ url('profile/cart') }}/{{ $pesanan_detail->id }}" method="post">
                                    @csrf
                                    {{ method_field('DELETE') }}
                        ...
                        <tr>
                            <td colspan="7" align="right"><a href="{{ url('/konfirmasi-cart') }}"
                                    class="btn btn-success" onclick="return confirm('Anda yakin akan Check Out ?');">
                                    <i class="fa fa-shopping-cart"></i>
                                    Lakukan Pembayaran
                                </a>
                                <a href="{{url('/')}}" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Kembali
                                </a></td>
                            <td align="right"></td>
                        </tr>
                    </tbody>
